...
After the results are saved the first thing to do is to plot change of longitude and latitude over time. We concider this graph being the most important.
