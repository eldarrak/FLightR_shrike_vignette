...
```{r}
plot_slopes_by_location(Proc.data=FLightR.data, location=c(12.23, 55.98))
...
```{r eval=FALSE}
download.file('https://git.io/fAKP5', 'tmp1.rmd', cacheOK = FALSE)
rmarkdown::render('tmp1.rmd', output_format = 'html_document',
